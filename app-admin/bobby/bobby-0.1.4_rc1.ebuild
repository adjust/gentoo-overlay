...
SRC_URI="https://github.com/adjust/${PN}/archive/v${MY_PV}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/${MY_P}"
...
pkg_nofetch() {
	...
	einfo "Visit the repository and download the archive for v${MY_PV}:"
	einfo ""
	einfo "  https://github.com/adjust/${PN}/archive/v${MY_PV}.tar.gz"
	einfo ""
