...
EGO_SUM=(
	...
	"github.com/aerospike/aerospike-client-go v4.4.0+incompatible/go.mod"
	"github.com/aerospike/aerospike-client-go/v6 v6.10.0"
    "github.com/aerospike/aerospike-client-go/v6 v6.10.0/go.mod"
	"github.com/aerospike/aerospike-client-go/v6 v6.15.1"
	"github.com/aerospike/aerospike-client-go/v6 v6.15.1/go.mod"
	...
	"github.com/jameskeane/bcrypt v0.0.0-20120420032655-c3cd44c1e20f/go.mod"
    ...
    "github.com/k0kubun/pp/v3 v3.1.0/go.mod"
	"github.com/k0kubun/pp/v3 v3.2.0"
	"github.com/k0kubun/pp/v3 v3.2.0/go.mod"
	...
	"go.opentelemetry.io/otel/sdk/metric v1.21.0/go.mod"
	"go.opentelemetry.io/otel/metric v1.21.0"
	"go.opentelemetry.io/otel/metric v1.21.0/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc v0.44.0"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc v0.44.0/go.mod"
...
src_compile() {
	export GOPATH="${S}"
	# Debug output to verify the directory structure
	echo "Compiling from $(pwd)"

	# Compile the Go application from the correct directory
	go build -o "${S}/bin/aerospike-prometheus-exporter" ./cmd || die "Build failed"
}
