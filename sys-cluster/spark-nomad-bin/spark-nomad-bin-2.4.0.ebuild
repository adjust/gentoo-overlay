...
SRC_URI="https://github.com/hashicorp/nomad-spark/releases/download/v${PV}-nomad-0.8.6-20181220/spark-${PV}-bin-nomad-0.8.6-20181220.tgz -> ${P}.tgz "
...
S="${WORKDIR}/spark-${PV}-bin-nomad-0.8.6-20181220"
