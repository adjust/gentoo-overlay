...
SRC_URI="https://files.adjust.com/binkernel-${PVR}.tar.xz
	sources? (
		https://files.adjust.com/buildkernel-${PVR}
		https://files.adjust.com/Module.symvers-${PVR}
	)"

IUSE="sources"

RDEPEND="sources? ( =sys-kernel/gentoo-sources-${PV} )"
